...
var chunk_5P4WR3QW_exports = {};
__export(chunk_5P4WR3QW_exports, {
  MergeSchemasError: () => MergeSchemasError,
  mergeSchemas: () => mergeSchemas
});
module.exports = __toCommonJS(chunk_5P4WR3QW_exports);
  ...
  const mergeSchemasEither = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        return import_chunk_PP22IZ7I.prismaSchemaWasm.merge_schemas(params);
      },
      (e) => ({
        type: "wasm-error",
