...
var chunk_EBLNHWW6_exports = {};
__export(chunk_EBLNHWW6_exports, {
  getEnginesInfo: () => getEnginesInfo,
  resolveEngine: () => resolveEngine
});
module.exports = __toCommonJS(chunk_EBLNHWW6_exports);
...
async function resolveEngine(binaryName) {
  ...
  const enginePathEither = await (0, import_function2.pipe)(
    pathFromEnvOption,
    fold(
      () => (0, import_chunk_5PJQQKQI.safeResolveBinary)(binaryName),
  ...
  const versionEither = await (0, import_function2.pipe)(
    ...
    (0, import_chunk_5DBOS77Y.chain)((enginePath) => {
      return (0, import_chunk_L6V54WGO.safeGetEngineVersion)(enginePath, binaryName);
    })
  )();
  const engineInfo = {
