...
var chunk_3B4NRXF6_exports = {};
__export(chunk_3B4NRXF6_exports, {
  GetDmmfError: () => GetDmmfError,
  externalToInternalDmmf: () => import_get_dmmf2.externalToInternalDmmf,
  getDMMF: () => getDMMF,
  getInternalDMMF: () => getInternalDMMF
});
module.exports = __toCommonJS(chunk_3B4NRXF6_exports);
...
var debugErrorType = (0, import_chunk_TZJROXB3.createDebugErrorType)(debug, "getDmmfWasm");
...
[Context: getDmmf]`;
    super((0, import_chunk_BTM246VF.addVersionDetailsToErrorMessage)(errorMessageWithContext));
...
function mapWasmPanicToGetDmmfError(error, reason) {
  ...
  return new GetDmmfError((0, import_chunk_TZJROXB3.parseQueryEngineError)({ errorOutput, reason }));
}
