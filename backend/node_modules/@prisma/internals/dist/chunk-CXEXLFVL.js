...
var chunk_CXEXLFVL_exports = {};
__export(chunk_CXEXLFVL_exports, {
...
module.exports = __toCommonJS(chunk_CXEXLFVL_exports);
...
async function execaCommand({
  ...
  schemaEnginePath = schemaEnginePath || await (0, import_chunk_5PJQQKQI.resolveBinary)(import_fetch_engine.BinaryType.SchemaEngineBinary);
  try {
