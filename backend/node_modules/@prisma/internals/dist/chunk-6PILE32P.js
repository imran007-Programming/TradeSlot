...
var chunk_6PILE32P_exports = {};
__export(chunk_6PILE32P_exports, {
...
module.exports = __toCommonJS(chunk_6PILE32P_exports);
...
var import_chunk_4YZJJPK2 = require("./chunk-4YZJJPK2.js");
var import_chunk_ZB2V476P = require("./chunk-ZB2V476P.js");
var import_chunk_L2BUQUNG = require("./chunk-L2BUQUNG.js");
var import_chunk_5P4WR3QW = require("./chunk-5P4WR3QW.js");
var import_chunk_2BXDHSSY = require("./chunk-2BXDHSSY.js");
var import_chunk_PP22IZ7I = require("./chunk-PP22IZ7I.js");
...
async function formatSchema({ schemas }, inputFormattingOptions) {
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(() => {
      import_chunk_PP22IZ7I.prismaSchemaWasm.debug_panic();
    });
  }
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(() => {
    ...
    const lintDiagnostics2 = (0, import_chunk_L2BUQUNG.lintSchema)({ schemas: formattedMultipleSchemas2 });
    return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
  });
  const lintWarnings = (0, import_chunk_L2BUQUNG.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_PP22IZ7I.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function processSchemaResult({
  ...
  const configFromPsl = await (0, import_chunk_4YZJJPK2.getConfig)({ datamodel: schemaResult.schemas });
...
async function getGenerators(options) {
  ...
  const dmmf = await (0, import_chunk_ZB2V476P.getDMMF)({ datamodel: schemaContext.schemaFiles });
  if (dmmf.datamodel.models.length === 0 && !allowNoModels) {
    if (schemaContext.primaryDatasource.provider === "mongodb") {
      throw new Error(import_chunk_NUKBOD54.missingModelMessageMongoDB);
    }
    throw new Error(import_chunk_NUKBOD54.missingModelMessage);
  }
...
You need to define \`output\` in the generator block in the schema file.`
        ...
        const datamodel = (0, import_chunk_5P4WR3QW.mergeSchemas)({ schemas: schemaContext.schemaFiles });
        const options2 = {
          datamodel,
